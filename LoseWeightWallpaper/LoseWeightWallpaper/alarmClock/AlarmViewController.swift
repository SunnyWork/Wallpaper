...
class AlarmViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  override func viewWillAppear(_ animated: Bool) {
    ...
    self.btnLeft?.setTitle("Close", for: UIControlState.normal)
  ...
  func init_ui() -> Void
  {
    self.navTitle?.text = "Alarms"
    
    self.btnLeft?.setTitle("Edit", for: UIControlState.normal)
    self.btnRight?.setTitle("Add", for: UIControlState.normal)
