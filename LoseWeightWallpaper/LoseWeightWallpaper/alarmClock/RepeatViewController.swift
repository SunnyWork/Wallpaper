...
class RepeatViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func init_data() -> Void
    {
        self.arrayData = [type_repeat_title.never.rawValue, type_repeat_title.day.rawValue, type_repeat_title.weekday.rawValue, type_repeat_title.weekdayOrdinal.rawValue]
    }
    ...
    func layoutCell(tableView: UITableView, indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let labelTitle : UILabel = UILabel.init(frame: CGRect(x: Int(spacingLayoutLeft), y: 0, width: 140, height: cellHeight))
