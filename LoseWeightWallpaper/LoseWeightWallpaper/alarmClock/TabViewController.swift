...
class TabViewController: BaseViewController {
  ...
  fileprivate var textfield : UITextView?
  ...
  func init_ui() -> Void
  {
    ...
    let view : UIView = UIView.init(frame: scrollView.bounds)
    ...
    self.textfield = UITextView(frame: CGRect(x: 10, y: 1, width: screenWidth - 20, height: 200))
